<template xmlns:v-finger="http://www.w3.org/1999/xhtml">
    <div v-show="isShow"
         ...
         >
      <div v-show="isEdit" >
        <div  class="lt" :style="tipStyle"  @touchstart.stop="deleteElemet($event)">
          <i class="el-icon-close"></i>
        </div>
        <div  ref="rb" class="rb" :style="tipStyle" @touchstart.stop="scaletouchStart" @touchmove.stop="scaletouchMove" @touchend.stop="scaletouchEnd"><i class="el-icon-d-caret"></i></div>
      </div>
